...
export const adminTabs = [
  ...
  },
  {
    ...
    content: (
      <div className="w-full max-h-[calc(100vh-350px)] overflow-y-auto p-8 bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl shadow-2xl animate-in fade-in zoom-in duration-300">
        <div className="mb-8 border-b border-slate-800 pb-4">
          <h2 className="text-3xl font-bold text-white">Button Appearance verwalten</h2>
          <p className="text-slate-400 mt-2">Passe das Aussehen aller Buttons an - ändere Gradient-Farben, Opacity und Hintergrundfarbe.</p>
        </div>
        <AppearanceEditor />
      </div>
    ),
